...
**	compile with gcc -O3 -o mm mm.c -lblas
*/
#include <unistd.h>
#include <stdio.h>
#include <stdlib.h>
...
/*
** standard matrix multiplication (ijk)
*/
void
mmul_ijk(int b, double C[N][N], double A[N][N], double B[N][N])
{
    int    i, j, k;
...
*/
void
mmul_blas(int b, double C[N][N], double A[N][N], double B[N][N])
{
    int    i, j, k;
    int    i0, j0, k0;
