...
class FibTest(c: Core) extends BaseTester(c) {
  val app = Array(
    ...
    /*[0040003c]*/ StrUInt("00000000"), //  nop                      ; 10: nop 
    /*[00400040]*/ StrUInt("afbf0014"), //  sw $31, 20($29)          ; 11: sw $ra, 20($sp) 
    /*[00400044]*/ StrUInt("afbe0010"), //  sw $30, 16($29)          ; 12: sw $fp, 16($sp) 
    /*[00400048]*/ StrUInt("27be001c"), //  addiu $30, $29, 28       ; 13: addu $fp, $sp, 28 
    /*[0040004c]*/ StrUInt("34100000"), //  ori $16, $0, 0           ; 14: li $s0, 0 
    /*[00400050]*/ StrUInt("00000000"), //  nop                      ; 15: nop 
    /*[00400054]*/ StrUInt("00000000"), //  nop                      ; 16: nop 
    /*[00400058]*/ StrUInt("00000000"), //  nop                      ; 17: nop 
    /*[0040005c]*/ StrUInt("34110014"), //  ori $17, $0, 20          ; 18: li $s1, 20 
    /*[00400060]*/ StrUInt("00102021"), //  addu $4, $0, $16         ; 19: move $a0, $s0 
    /*[00400064]*/ StrUInt("0c100037"), //  jal 0x004000dc [fib]     ; 20: jal fib 
    ...
    /*[00400078]*/ StrUInt("0002c821"), //  addu $25, $0, $2         ; 25: move $t9, $v0 
    /*[0040007c]*/ StrUInt("22100001"), //  addi $16, $16, 1         ; 26: addi $s0, $s0, 1 
    ...
    /*[00400090]*/ StrUInt("0211402b"), //  sltu $8, $16, $17        ; 31: sltu $t0, $s0, $s1 
    ...
    /*[004000a4]*/ StrUInt("1500ffee"), //  bne $8, $0, -72 [l1-0x004000a4]; 36: bne $t0, $zero, l1 
    ...
    /*[004000b8]*/ StrUInt("00051021"), //  addu $2, $0, $5          ; 41: move $v0, $a1 
    /*[004000bc]*/ StrUInt("8fbf0014"), //  lw $31, 20($29)          ; 42: lw $ra, 20($sp) 
    /*[004000c0]*/ StrUInt("8fbe0010"), //  lw $30, 16($29)          ; 43: lw $fp, 16($sp) 
    /*[004000c4]*/ StrUInt("27bd0020"), //  addiu $29, $29, 32       ; 44: addu $sp, $sp, 32 
    /*[004000c8]*/ StrUInt("03e00008"), //  jr $31                   ; 45: jr $ra 
    ...
    /*[004000dc]*/ StrUInt("27bdffe0"), //  addiu $29, $29, -32      ; 50: subu $sp, $sp, 32 
    ...
    /*[004000f0]*/ StrUInt("afbf0014"), //  sw $31, 20($29)          ; 55: sw $ra, 20($sp) 
    /*[004000f4]*/ StrUInt("afbe0010"), //  sw $30, 16($29)          ; 56: sw $fp, 16($sp) 
    /*[004000f8]*/ StrUInt("27be001c"), //  addiu $30, $29, 28       ; 57: addu $fp, $sp, 28 
    ...
    /*[0040010c]*/ StrUInt("afc40000"), //  sw $4, 0($30)            ; 62: sw $a0, 0($fp) 
    /*[00400110]*/ StrUInt("8fc20000"), //  lw $2, 0($30)            ; 63: lw $v0, 0($fp) 
    ...
    /*[00400124]*/ StrUInt("1440000b"), //  bne $2, $0, 44 [$L2-0x00400124]; 68: bne $v0, $zero, $L2 
    ...
    /*[00400138]*/ StrUInt("34020000"), //  ori $2, $0, 0            ; 73: li $v0, 0 
    /*[0040013c]*/ StrUInt("0810008f"), //  j 0x0040023c [$L1]       ; 74: j $L1 
    ...
    /*[00400150]*/ StrUInt("34080001"), //  ori $8, $0, 1            ; 79: li $t0, 1 
    /*[00400154]*/ StrUInt("00000000"), //  nop                      ; 80: nop 
    /*[00400158]*/ StrUInt("00000000"), //  nop                      ; 81: nop 
    /*[0040015c]*/ StrUInt("00000000"), //  nop                      ; 82: nop 
    /*[00400160]*/ StrUInt("00000000"), //  nop                      ; 83: nop 
    /*[00400164]*/ StrUInt("0102482b"), //  sltu $9, $8, $2          ; 84: sltu $t1, $t0, $v0 
    /*[00400168]*/ StrUInt("00000000"), //  nop                      ; 85: nop 
    /*[0040016c]*/ StrUInt("00000000"), //  nop                      ; 86: nop 
    /*[00400170]*/ StrUInt("00000000"), //  nop                      ; 87: nop 
    /*[00400174]*/ StrUInt("00000000"), //  nop                      ; 88: nop 
    /*[00400178]*/ StrUInt("1520000a"), //  bne $9, $0, 40 [$L3-0x00400178]; 89: bne $t1, $zero, $L3 
    ...
    /*[0040018c]*/ StrUInt("0810008f"), //  j 0x0040023c [$L1]       ; 94: j $L1 
    ...
    /*[004001a0]*/ StrUInt("8fc30000"), //  lw $3, 0($30)            ; 99: lw $v1, 0($fp) 
    /*[004001a4]*/ StrUInt("00000000"), //  nop                      ; 100: nop 
    /*[004001a8]*/ StrUInt("00000000"), //  nop                      ; 101: nop 
    /*[004001ac]*/ StrUInt("00000000"), //  nop                      ; 102: nop 
    /*[004001b0]*/ StrUInt("00000000"), //  nop                      ; 103: nop 
    /*[004001b4]*/ StrUInt("2462ffff"), //  addiu $2, $3, -1         ; 104: subu $v0, $v1, 1 
    /*[004001b8]*/ StrUInt("00000000"), //  nop                      ; 105: nop 
    /*[004001bc]*/ StrUInt("00000000"), //  nop                      ; 106: nop 
    /*[004001c0]*/ StrUInt("00000000"), //  nop                      ; 107: nop 
    /*[004001c4]*/ StrUInt("00000000"), //  nop                      ; 108: nop 
    /*[004001c8]*/ StrUInt("00022021"), //  addu $4, $0, $2          ; 109: move $a0, $v0 
    /*[004001cc]*/ StrUInt("0c100037"), //  jal 0x004000dc [fib]     ; 110: jal fib 
    ...
    /*[004001e0]*/ StrUInt("afc20004"), //  sw $2, 4($30)            ; 115: sw $v0, 4($fp) 
    /*[004001e4]*/ StrUInt("8fc30000"), //  lw $3, 0($30)            ; 116: lw $v1, 0($fp) 
    /*[004001e8]*/ StrUInt("00000000"), //  nop                      ; 117: nop 
    /*[004001ec]*/ StrUInt("00000000"), //  nop                      ; 118: nop 
    /*[004001f0]*/ StrUInt("00000000"), //  nop                      ; 119: nop 
    /*[004001f4]*/ StrUInt("00000000"), //  nop                      ; 120: nop 
    /*[004001f8]*/ StrUInt("2462fffe"), //  addiu $2, $3, -2         ; 121: subu $v0, $v1, 2 
    /*[004001fc]*/ StrUInt("00000000"), //  nop                      ; 122: nop 
    /*[00400200]*/ StrUInt("00000000"), //  nop                      ; 123: nop 
    /*[00400204]*/ StrUInt("00000000"), //  nop                      ; 124: nop 
    /*[00400208]*/ StrUInt("00000000"), //  nop                      ; 125: nop 
    /*[0040020c]*/ StrUInt("00022021"), //  addu $4, $0, $2          ; 126: move $a0, $v0 
    /*[00400210]*/ StrUInt("0c100037"), //  jal 0x004000dc [fib]     ; 127: jal fib 
    /*[00400214]*/ StrUInt("00000000"), //  nop                      ; 128: nop 
    /*[00400218]*/ StrUInt("00000000"), //  nop                      ; 129: nop 
    /*[0040021c]*/ StrUInt("00000000"), //  nop                      ; 130: nop 
    /*[00400220]*/ StrUInt("00000000"), //  nop                      ; 131: nop 
    /*[00400224]*/ StrUInt("8fc30004"), //  lw $3, 4($30)            ; 132: lw $v1, 4($fp) 
    /*[00400228]*/ StrUInt("00000000"), //  nop                      ; 133: nop 
    /*[0040022c]*/ StrUInt("00000000"), //  nop                      ; 134: nop 
    /*[00400230]*/ StrUInt("00000000"), //  nop                      ; 135: nop 
    /*[00400234]*/ StrUInt("00000000"), //  nop                      ; 136: nop 
    /*[00400238]*/ StrUInt("00431021"), //  addu $2, $2, $3          ; 137: addu $v0, $v0, $v1 
    /*[0040023c]*/ StrUInt("8fbf0014"), //  lw $31, 20($29)          ; 138: lw $ra, 20($sp) 
    /*[00400240]*/ StrUInt("8fbe0010"), //  lw $30, 16($29)          ; 139: lw $fp, 16($sp) 
    /*[00400244]*/ StrUInt("27bd0020"), //  addiu $29, $29, 32       ; 140: addu $sp, $sp, 32 
    /*[00400248]*/ StrUInt("00000000"), //  nop                      ; 141: nop 
    /*[0040024c]*/ StrUInt("00000000"), //  nop                      ; 142: nop 
    /*[00400250]*/ StrUInt("03e00008"), //  jr $31                   ; 143: jr $ra 
    /*[00400254]*/ StrUInt("00000000"), //  nop                      ; 144: nop 
    /*[00400258]*/ StrUInt("00000000"), //  nop                      ; 145: nop 
    /*[0040025c]*/ StrUInt("00000000"), //  nop                      ; 146: nop 
    /*[00400260]*/ StrUInt("00000000")  //  nop                      ; 147: nop 
)
  wr(UInt(0), Bits(0)) // skip reset
  for (addr <- 0 until app.length) {
    wr(UInt(addr), app(addr))
